                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="judul"
                                                                aria-describedby="judul" name="storeName"
                                                                value="best life" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="isbn"
                                                                aria-describedby="isbn" name="isbn" value="819284723" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                     ...
                                                     <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control pt-1" id="newPdfFile" name="newPdfFile" accept=".pdf" />
                                                        </div>
                                                    </div>
                                                    <div class="col">
