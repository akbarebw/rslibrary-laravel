        ...
        <div class="d-flex" id="wrapper" data-aos="fade-right">
            ...
            <div class="border-right" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{ url('dashboard-buku') }}" class="list-group-item list-group-item-action">Buku saya</a>
                    <a href="/dashboard-peminjaman.html" class="list-group-item list-group-item-action">Peminjaman</a>
                    <a href="/dashboard-settings.html" class="list-group-item list-group-item-action">Settings</a>
